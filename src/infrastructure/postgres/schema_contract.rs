...
const REQUIRED_COLUMNS: &[&str] = &[
    ...
    "hook_private.ip_blocks.blocks|integer|true",
    "hook_private.ip_blocks.blocked_until|timestamp with time zone|false",
    "hook_private.ip_blocks.permanent|boolean|true",
...
const REQUIRED_CONSTRAINTS: &[&str] = &[
    ...
    "hook_private.ip_blocks.ip_blocks_permanent_has_no_deadline|c",
...
const REQUIRED_DEFAULTS: &[&str] = &[
    ...
    "hook_private.ip_blocks.blocks|0",
    "hook_private.ip_blocks.permanent|false",
