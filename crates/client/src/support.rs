...
pub const REPOSITORY: &str = "https://github.com/teamofsilicons/silicon-hook";
/// Public instructive and reference documentation.
pub const DOCUMENTATION: &str = "https://docs.hook.teamofsilicons.com";
/// Published Rust package.
pub const PACKAGE: &str = "https://crates.io/crates/silicon-hook-client";
...
pub fn report_body(message: &str, pr: Option<&str>) -> Result<String, String> {
    ...
    Ok(format!(
        "{message}\n\n{}\n\nSubmitted with silicon-hook-client {}.\n",
...
mod tests {
    ...
    fn reports_preserve_user_text_and_validate_prs() {
        let body = report_body(
            "Login failed\nSteps: ...",
            Some("https://github.com/teamofsilicons/silicon-hook/pull/42"),
        )
        ...
        assert!(
            report_body(
                "bug",
                Some("https://github.com/teamofsilicons/silicon-hook/pull/42?token=secret")
            )
            .is_err()
        );
    }
