...
const REQUIRED_COLUMNS: &[&str] = &[
    ...
    "hook_private.ting_recipient_bindings.environment_id|uuid|true",
    "hook_private.ting_recipient_bindings.org_id|text|true",
    "hook_private.ting_recipient_bindings.silicon_id|text|true",
    "hook_private.ting_recipient_bindings.recipient_id|text|true",
    "hook_private.ting_recipient_bindings.created_at|timestamp with time zone|true",
    "hook_private.ting_recipient_bindings.encrypted_authority|jsonb|false",
    "hook_private.ting_recipient_bindings.authority_version|uuid|false",
    ...
    "hook_private.ting_publisher_credentials.environment_id|uuid|true",
    "hook_private.ting_publisher_credentials.environment_generation|bigint|true",
    "hook_private.ting_publisher_credentials.org_id|text|true",
    "hook_private.ting_publisher_credentials.id|uuid|true",
    "hook_private.ting_publisher_credentials.provision_request_hash|bytea|true",
    "hook_private.ting_publisher_credentials.provision_input_hash|bytea|true",
    "hook_private.ting_publisher_credentials.encrypted_credentials|jsonb|true",
    "hook_private.ting_publisher_credentials.actor_id|text|false",
    "hook_private.ting_publisher_credentials.expires_at|timestamp with time zone|false",
    "hook_private.ting_publisher_credentials.validated|boolean|true",
    "hook_private.ting_publisher_credentials.rejected|boolean|true",
    "hook_private.ting_publisher_credentials.operation_key|uuid|false",
    "hook_private.ting_publisher_credentials.operation_started_at|timestamp with time zone|false",
    "hook_private.ting_publisher_credentials.lease_id|uuid|false",
    "hook_private.ting_publisher_credentials.lease_until|timestamp with time zone|false",
    "hook_private.ting_publisher_credentials.created_at|timestamp with time zone|true",
    "hook_private.ting_publisher_credentials.updated_at|timestamp with time zone|true",
...
const REQUIRED_CONSTRAINTS: &[&str] = &[
    ...
    "hook_private.ting_recipient_bindings.ting_bindings_scope_unique|u",
    "hook_private.ting_recipient_bindings.ting_bindings_outbox_identity_unique|u",
    "hook_private.ting_recipient_bindings.ting_bindings_org_valid|c",
    "hook_private.ting_recipient_bindings.ting_bindings_silicon_valid|c",
    "hook_private.ting_recipient_bindings.ting_bindings_recipient_valid|c",
    "hook_private.ting_recipient_bindings.ting_bindings_created_finite|c",
    "hook_private.ting_recipient_bindings.ting_observer_authority_pair|c",
    ...
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_pkey|p",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_id_key|u",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_org_id_check|c",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_provision_request_hash_check|c",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_provision_input_hash_check|c",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_encrypted_credentials_check|c",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_actor_id_check|c",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_check|c",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_check1|c",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_check2|c",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_check3|c",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_check4|c",
    "hook_private.ting_publisher_credentials.ting_publisher_credentials_check5|c",
...
const REQUIRED_INDEXES: &[&str] = &[
    "hook_private.ting_outbox.ting_outbox_by_binding",
...
const REQUIRED_DEFAULTS: &[&str] = &[
    ...
    "hook_private.ting_recipient_bindings.environment_id|hook_private.environment_id()",
    "hook_private.ting_recipient_bindings.created_at|clock_timestamp()",
    ...
    "hook_private.ting_publisher_credentials.environment_id|hook_private.environment_id()",
    "hook_private.ting_publisher_credentials.validated|false",
    "hook_private.ting_publisher_credentials.rejected|false",
    "hook_private.ting_publisher_credentials.created_at|clock_timestamp()",
    "hook_private.ting_publisher_credentials.updated_at|clock_timestamp()",
